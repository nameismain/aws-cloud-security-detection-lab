...
## 개요
이 문서는 Fintech Cloud Threat Detection Lab의 단계별 구현 계획을 정리한 문서입니다.
...
동일한 출발지 IP에서 5분 이내 SSH 로그인 실패가 5회 이상 발생하면
Brute Force 의심 행위로 판단한다.
...
**산출물**
    ...
    scenarios/01-public-ssh/README.md
    scenarios/01-public-ssh/detection-logic.md
...
**산출물**
    ...
    scenarios/02-public-s3/README.md
    scenarios/02-public-s3/detection-logic.md
...
**산출물**
    ...
    scenarios/03-overprivileged-iam/README.md
    scenarios/03-overprivileged-iam/detection-logic.md
...
**산출물**
    ...
    scenarios/04-cloudtrail-disabled/README.md
    scenarios/04-cloudtrail-disabled/detection-logic.md
...
**산출물**
    ...
    scenarios/05-public-database/README.md
    scenarios/05-public-database/detection-logic.md
